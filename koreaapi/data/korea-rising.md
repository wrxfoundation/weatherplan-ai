# Korea Rising — verified K-pop snapshot (2026-08-11)
...
**Rescene** — Love Attack  
_Circle Digital Chart #1 (via Wikipedia) 2026-08-11 02:48 UTC · Skill Score 0.70_

## 🎬 Latest official releases (YouTube)
- **NCT Dream** — 🍵녹차빛으로 물든 하루 in 항저우🌿 (with 러냥이와 쥔와와) | 드림 바이 드림 | DREAM x DREAM
- **STAYC** — [EP.01] 회사에 억울하게 갇혀있는 직장인들 퇴근시켜라 | 재이 ASMR🌿
- **PSY** — Die Sprache der Musik - Story of Light & Orkaia  [HQ]
- **ITZY** — 𝓗𝓮𝔂, 𝔀𝓱𝔂 𝓼𝓸 𝓼𝓮𝓻𝓲𝓸𝓾𝓼? ♠️🐱♣️ #ITZY #ALLINMIDZY #ITZY_CHESHIRE #CheshireChallenge
- **aespa** — “오늘이 평생 기억될 것 같아” 낭만 다 때려넣은 에스파의 밤 | ❮aesParty❯ EP.16 예고
