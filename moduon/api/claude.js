...
- 파트너(분양몰) 창업 문의에는 "온라인 건물주 되기" 프로그램을 안내합니다: 대리점 가입비 200만원 + 월 이용료 30만원, 운영 수수료 10%, 월 매출 1,000만원 기준 순수익 예시 870만원(수수료·이용료 차감 후, 실제 수익 보장 아님).
...
- 대표 단말(출고가 / 번호이동 공통지원금): 갤럭시 Z 폴드8 1TB(3,152,600원/50만) · 갤럭시 S26 울트라(1,969,000원/45만) · 아이폰 17 프로(1,750,000원/28만) · 갤럭시 A56(598,400원/40만)
- 기기변경은 공통지원금이 번호이동보다 약 10만원 낮고, 010신규는 중간 수준
- 추가지원금: 공통지원금의 15%(법정 한도) / 할부수수료: 연 5.9% 원리금균등 (12·24·36개월)
- 선택약정: 지원금 대신 요금 25% 할인(24개월) — 어느 쪽이 유리한지 총액 기준으로 비교해 안내
- 대표 예시: 폴드8 1TB 번호이동 + 초이스110(110,000원) 24개월 → 월 납부 약 227,450원(VAT 포함)
