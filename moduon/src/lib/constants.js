// ─── 모두온 공통 상수 ───────────────────────────────────────────
// 카테고리 순서: 인터넷/TV · 휴대폰 · 이사 · 정수기 · 렌탈 · 보험 · 가전 · 생활/기타
// hidden: true 는 사업 초기 비노출 — 소비자 화면의 카테고리 스트립에서만 감춘다.
// 삭제가 아니므로 카테고리 페이지·상담 폼·어드민 상품 관리는 그대로 8종을 다룬다.
// 취급을 시작하는 카테고리부터 hidden 을 지우면 즉시 노출된다.
