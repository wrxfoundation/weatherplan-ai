...
/* 민감도 검증 실측치 (test-sensitivity 실행 결과 · 2026.07.25) */
const SENSITIVITY_ROWS = [
  ["0. 방치 상태", 33, "F", [59, 14, 35, 14]],
  ["1. + JSON-LD 문법 수정", 40, "F", [66, 22, 45, 14]],
  ["2. + 메타·공유 카드", 49, "F", [83, 22, 45, 43]],
  ["3. + 답변형 콘텐츠·alt", 71, "C", [87, 56, 85, 43]],
  ["4. + 엔티티·FAQ·신뢰 신호", 94, "A", [97, 100, 95, 71]],
  ["5. + 확산 신호 전부", 100, "A", [100, 100, 100, 100]],
];
    ...
    <div style={{ background: T.surface, minHeight: "100vh" }}>
      ...
      <div className="max-w-[980px] mx-auto px-6" style={{ paddingTop: 40, paddingBottom: 80 }}>
        ...
        <P>
          ...
          LLM(claude-opus-4-8)이 고정 루브릭으로 심사합니다. 서버가 페이지를 재수집해
