...
export const PRICING_KPIS = [
  { k: "진입비", v: "25만", note: "부가세 별도 · 합계 27.5만 · 확정", color: "#1E7A5A" },
  { k: "월 구독료", v: "7.7만", note: "최소 약정 12개월 · 확정", color: "#1E7A5A" },
...
export const PLANS = [
  { k: "진입비 (최초 1회)", price: "25만", inc: "Fit3 · 케어박스 · 21항목 점검 · 앱 설치 · 리포트", who: "부가세 별도 · 합계 27.5만", n: "확정", tone: "ok" },
  { k: "월 구독 (기본)", price: "7.7만", inc: "안심방문 월 1회 · 병원 동행 연 1회 · 관제 · 리포트", who: "최소 약정 12개월", n: "확정", tone: "ok" },
...
export const OPTIONS_CATALOG = [
  ...
  { k: "구매대행 (약국 · 장보기)", price: "수수료 8%", attach: 44, note: "저항이 가장 적은 옵션 — 파스 · 박카스 · 판피린" },
...
export const PRICING_UNIT = {
  ...
  rows: [
    { k: "월 구독료", v: "+77,000", tone: "ok", note: "고객 결제액" },
    { k: "대리점망 수당 (60%)", v: "−46,200", tone: "bad", note: "직판 전환 시 −26,950" },
    { k: "회사 실입금", v: "30,800", tone: "info", note: "여기서 원가를 뺀다" },
    { k: "안심방문 월 1회 원가", v: "−65,000", tone: "bad", note: "회의 실측 원가" },
    { k: "병원 동행 연 1회 (월 배분)", v: "−9,167", tone: "bad", note: "110,000 ÷ 12" },
    { k: "기본 구독 월 손익", v: "−43,367", tone: "bad", note: "옵션 없이는 적자" },
  ],
  note: "진입비 25만은 Fit3 7만 + 케어박스 3만 + 방문 원가로 사실상 본전입니다. 손익분기는 가구당 월 옵션 매출 약 12만(마진 35% 가정)이며, 현재 부착률 22%로는 미달입니다. 회의에서도 “업셀링을 안 하면 적자를 무조건 보는 구조”로 확인된 사항입니다.",
};
export const PRICING_DECISIONS = [
  { k: "진입비 25만 · 월 7.7만 확정", why: "일시금 50~60만은 영업 현장 저항이 크다 — “월 77,000원”은 거부감이 없다", opt: "확정 — 부가세 별도 · 최소 약정 12개월", state: "확정 (8/01)", tone: "ok" },
