...
export const TEACHER_INBOX = [
  {
    ...
    minsAgo: 85,
    durationSec: 34,
    text: "어머님, 내일 정형외과 예약 10시로 잡았습니다. 9시 반에 모시러 가겠습니다.",
  },
  {
    id: "t2",
    dir: "out",
  ...
  },
  {
    ...
    minsAgo: 400,
    durationSec: 51,
    text: "오늘 혈압 재신 것 잘 받았습니다. 저녁 약은 꼭 드시고 주무세요.",
  },
  // 곧 지워지는 것 — 24시간 원칙이 눈에 보이게 하나 남겨 둔다 (23시간 20분 전)
  {
    ...
    minsAgo: 1400,
    durationSec: 27,
    text: "어제 장 봐 온 것 냉장고 두 번째 칸에 넣어 두었습니다.",
  },
];
...
//
// 날짜로 고르므로(아래 todayTopic) 같은 날 여러 번 열어도 같은 것이 나온다 —
...
// 오늘 것 하나 — 날짜 기준이라 같은 날엔 같은 것이 나온다
export function todayTopic(d = new Date()) {
  const dayNum = Math.floor(
    Date.UTC(d.getFullYear(), d.getMonth(), d.getDate()) / 86400000
  );
  return GEN_TOPICS[dayNum % GEN_TOPICS.length];
}
