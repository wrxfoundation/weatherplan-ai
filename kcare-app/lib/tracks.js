...
export const CORE = [
  { icon: "users", k: "2인 1조, 예외 없음", v: "짝이 맞지 않으면 그 예약은 받지 않습니다." },
...
export const TRACKS = [
  ...
  },
  {
    ...
    billing: {
      ...
      confirmed: false,
      costBasis: null,
      note: "판매가 미확정. 이 트랙은 코어(2인 1조·기록)를 지키면 단가가 시장가보다 높아집니다 — 그 차이를 무엇으로 설명할지가 먼저입니다",
    },
    home: {
      title: "요청하신 일",
      badge: "진행 중 1건",
