...
| `elders` | 어르신 — 성별·생년·거주 동·위험도 · `care_location_type` (HOME / HOSPITAL, 실무자 피드백 2026-08-09: 자택·요양병원 이원화 — 체크리스트·기본제공품·리포트 카피가 이 값으로 갈린다. PMF 지표(가입률·리포트 열람률·만족도·옵션 전환율)도 이 컬럼으로 나눠 비교) | **S1** |
