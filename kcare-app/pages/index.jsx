...
const T = {
  ko: {
    ...
    h1: "부모님의 작은 변화를,\n가장 먼저 알아채는 사람",
    sub: "몸만이 아니라 마음도 봅니다. 매월 같은 사람이 같은 기준으로 몸·마음·집 21항목을 보고, 지난달과 달라진 점을 기록합니다. 말수가 줄고 외출이 없어지는 것이 혈압보다 먼저 오기 때문입니다. 위험도 기반 배차 · 24시간 관제 · 구독 멤버십.",
    demoState: "DEMO 상태",
    idle: "대기 — 시연 준비 완료",
    reset: "↺ 시연 초기화",
    ...
    visitChip: "동행 중 (체크인)",
    npsChip: "NPS 회복 콜 대기",
    roles: [["/service", "서비스 소개 (대외)"], ["/family", "가족 앱"], ["/elder", "어르신 화면"], ["/concierge-onboarding", "컨시어지 등록"], ["/concierge", "컨시어지"], ["/sales", "영업자"], ["/dispatch", "관제 콘솔"], ["/admin", "경영 콘솔"], ["/care-profile", "케어 프로필"]],
    steps: [
      { n: "01", role: "어르신", href: "/elder", text: "즉시 방문 요청 · 오늘 나는(어제 비교) · 복약 진행바 — SOS 는 바탕화면 바로가기로" },
  ...
  en: {
    ...
    roles: [["/service", "Service site"], ["/family", "Family app"], ["/elder", "Elder screen"], ["/concierge-onboarding", "Concierge signup"], ["/concierge", "Concierge"], ["/sales", "Sales rep"], ["/dispatch", "Dispatch console"], ["/admin", "Executive console"], ["/care-profile", "Care profile"]],
    steps: [
      { n: "01", role: "Elder", href: "/elder", text: "Immediate visit request · today-vs-yesterday · medication progress — SOS lives on the home-screen shortcut" },
