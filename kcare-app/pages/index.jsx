...
const T = {
  ko: {
    ...
    visitChip: "동행 중 (체크인)",
    npsChip: "NPS 회복 콜 대기",
    roles: [["/family", "가족 앱"], ["/elder", "어르신 화면"], ["/concierge-onboarding", "컨시어지 등록"], ["/concierge", "컨시어지"], ["/dispatch", "관제 콘솔"], ["/admin", "경영 콘솔"], ["/care-profile", "케어 프로필"]],
    steps: [
  ...
  en: {
    ...
    roles: [["/family", "Family app"], ["/elder", "Elder screen"], ["/concierge-onboarding", "Concierge signup"], ["/concierge", "Concierge"], ["/dispatch", "Dispatch console"], ["/admin", "Executive console"], ["/care-profile", "Care profile"]],
    steps: [
