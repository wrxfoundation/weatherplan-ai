    ...
    <>
      ...
      <div className="flex min-h-screen items-center justify-center bg-nav px-5">
        <div className="w-full max-w-[430px] py-14">
          ...
          <h1 className="mt-5 text-[34px] font-black leading-[1.35] text-white">
            부모의 병원 가는 길을
            <br />
            자녀가 대신 지킵니다
          </h1>
          ...
          <div className="mt-10 space-y-3">
            <Link
              href="/onboarding"
              className="btn-press block w-full rounded-2xl bg-gold py-4 text-center text-[17px] font-bold text-nav shadow-[inset_0_1px_0_rgba(255,255,255,.35)]"
            >
              {joined ? "가입 정보 다시 입력하기" : "가입 상담 시작하기"}
            </Link>
            <Link
              href="/family"
              className="btn-press block w-full rounded-2xl border border-white/25 py-4 text-center text-[17px] font-bold text-white"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <Link
                href="/elder"
                className="btn-press block rounded-2xl border border-white/25 py-4 text-center text-[17px] font-bold text-white"
              >
                어르신 화면
              </Link>
              <Link
          ...
          <div className="mt-10 border-t border-white/10 pt-5 text-[12px] leading-[1.8] text-white/40">
