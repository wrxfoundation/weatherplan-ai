...
const PATHS = {
  ...
  // 약 미션 성공 — 별 (참고 영상의 별 모으기 상호작용을 라인 아이콘으로)
  star: <path d="M12 3.8 14.5 8.9l5.6.8-4 4 .9 5.5L12 16.6l-5 2.6.9-5.5-4-4 5.6-.8L12 3.8Z" />,
  ...
  // ── 2026-09-04 시트 ──
  // 도와줘요 — 종. 시안(어르신 홈 우상단)이 종 모양이다. 문(door)은 '방문'이었는데
  // 도와줘요는 방문 요청보다 '부르는 것'이라 종이 맞다.
  bell: (
    <>
  ...
  // 재생 — 약 미션 카드 · 선생님 메시지 배너 (시안의 ▶)
  play: <path d="M8 5.5v13l10-6.5L8 5.5Z" />,
  // 내려받기 — 아래 화살표와 받침. 마음사서함의 '받은 목소리 저장'에 쓴다
  // (전에는 상자(box)를 썼는데 무엇인지 알 수 없다는 피드백 · 2026-09-10).
  download: (
    <>
      <path d="M12 4v11" />
  ...
  // 복지혜택 — 선물 상자. 나라에서 '주는 것'이라 상자로 그렸다.
  gift: (
    <>
      <path d="M4 10h16v10H4z" />
      <path d="M4 7h16v3H4zM12 7v13" />
      <path d="M12 7c-1.5-3.5-5-3.5-5-1.5S10 7 12 7Zm0 0c1.5-3.5 5-3.5 5-1.5S14 7 12 7Z" />
    </>
  ),
  // 결제 관리 — 카드 (보호자 마이 타일)
  card: (
