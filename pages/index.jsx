      ...
      <style>{`
        ...
        * { font-family: 'Pretendard Variable', Pretendard, 'Noto Sans KR', -apple-system, BlinkMacSystemFont, system-ui, sans-serif; }
        ...
        @media (prefers-reduced-motion: reduce) {
          .float-gentle, .reveal { animation: none !important; transition: none !important; opacity: 1 !important; transform: none !important; }
        }

        /* ─── 모바일 반응형: GlobalCases 카드 row ─── */
        .global-case-row {
          display: grid;
        ...
        .global-case-row .gc-result {
          justify-self: start;
        }
        @media (min-width: 768px) {
          .global-case-row {
            grid-template-columns: minmax(180px, 1fr) minmax(0, 2.4fr) auto;
            gap: 18px;
            align-items: center;
          }
          .global-case-row .gc-result {
        ...
        /* ─── Gemini-style 무지개 블러 애니메이션 (Hero NL input ambient) ─── */
        ...
        .rainbow-glow {
          ...
          background: conic-gradient(
            from 0deg,
            rgba(78, 179, 168, 0.6) 0%,
            rgba(231, 227, 255, 0.6) 25%,
            rgba(255, 104, 80, 0.5) 50%,
            rgba(244, 200, 200, 0.6) 75%,
            rgba(78, 179, 168, 0.6) 100%
          );
          filter: blur(8px);
          opacity: 0.55;
          z-index: -1;
          animation: rainbowSpin 8s linear infinite, rainbowPulse 4s ease-in-out infinite;
          pointer-events: none;
        }
        .rainbow-glow-active {
          opacity: 0.95;
          animation: rainbowSpin 4s linear infinite, rainbowPulse 2s ease-in-out infinite;
        }
        @media (prefers-reduced-motion: reduce) {
          .rainbow-glow { animation: none; opacity: 0.4; }
        }
        html { scroll-behavior: smooth; }
        body { background: ${T.canvas}; }
        ::selection { background: ${T.brandTeal}; color: ${T.primary}; }

        h1, h2, h3, h4 { word-break: keep-all; }
        p, li, span    { word-break: keep-all; }

        /* ─── Liquid Glass Card — HA.jsx heritage (blur 28 + saturate 200 + 1px hairline) ─── */
        .glass-card {
          position: relative;
          background: rgba(255, 255, 255, 0.62);
          backdrop-filter: blur(28px) saturate(200%);
          -webkit-backdrop-filter: blur(28px) saturate(200%);
          border: 1px solid rgba(229, 225, 214, 0.85);
          box-shadow:
            inset 0 0 0 1px rgba(255, 255, 255, 0.45),       /* 내부 1px 광택 라인 */
            inset 0 1px 0 rgba(255, 255, 255, 0.95),         /* 상단 화이트 광택 */
            inset 0 -1px 0 rgba(5, 0, 56, 0.03),             /* 하단 hairline */
            0 1px 2px rgba(5, 0, 56, 0.03),                  /* 가까운 그림자 */
            0 8px 24px rgba(5, 0, 56, 0.05);                 /* 떠 있는 깊이감 */
          transition: background 0.35s ease, border 0.35s ease, box-shadow 0.35s ease, transform 0.35s cubic-bezier(0.22, 1, 0.36, 1);
        }
        .glass-card-hover:hover {
          transform: translateY(-3px);
          background: rgba(255, 255, 255, 0.82);
          border: 1px solid rgba(201, 197, 183, 0.9);
          box-shadow:
            inset 0 0 0 1px rgba(255, 255, 255, 0.6),
            inset 0 1px 0 rgba(255, 255, 255, 1),
            inset 0 -1px 0 rgba(5, 0, 56, 0.05),
            0 2px 4px rgba(5, 0, 56, 0.05),
            0 16px 36px rgba(5, 0, 56, 0.08);
        }
        /* dark glass — for surface backgrounds */
        .glass-card-dark {
          background: rgba(5, 0, 56, 0.04);
          backdrop-filter: blur(20px) saturate(180%);
          -webkit-backdrop-filter: blur(20px) saturate(180%);
          border: 1px solid rgba(255, 255, 255, 0.6);
        }

        /* ─── Hero 전역 — 위에서 아래로 무지개빛 내리쬐는 ambient ─── */
        @keyframes heroAuroraDescend {
          0%, 100% {
        ...
        .hero-aurora::before {
          ...
          height: 100%;
          background:
            linear-gradient(180deg, rgba(78,179,168,0.22) 0%, rgba(78,179,168,0) 60%),
            linear-gradient(180deg, rgba(180,210,255,0.20) 0%, rgba(180,210,255,0) 55%),
            linear-gradient(180deg, rgba(231,227,255,0.22) 0%, rgba(231,227,255,0) 50%),
            linear-gradient(180deg, rgba(255,180,230,0.18) 0%, rgba(255,180,230,0) 50%),
            linear-gradient(180deg, rgba(255,200,160,0.16) 0%, rgba(255,200,160,0) 55%);
          background-size:
            100% 100%,
            100% 100%,
            100% 100%,
          ...
          filter: blur(30px);
          animation: heroAuroraDescend 14s ease-in-out infinite;
        }

        /* ─── NL input 무지개 테두리 (파스텔 무지개 + 회전 그라데이션) ─── */
        @keyframes nlBorderShine {
        ...
        .nl-shine::before {
          ...
          background: linear-gradient(
            90deg,
            rgba(78,179,168,0.75)   0%,
            rgba(180,210,255,0.85)  18%,
            rgba(231,227,255,0.85) 36%,
            rgba(255,180,230,0.75) 54%,
            rgba(255,165,135,0.75) 72%,
            rgba(255,220,180,0.85) 88%,
            rgba(78,179,168,0.75) 100%
          );
          background-size: 280% 100%;
          animation: nlBorderShine 7s linear infinite;
          -webkit-mask:
        ...
        .nl-shine.nl-shine-active::before {
          opacity: 1;
          inset: -2px;
          padding: 2px;
        ...
        /* 부드러운 외부 무지개 글로우 (테두리 옆에 살짝 빛이 새어나오는 느낌) */
        .nl-shine::after {
          content: '';
          position: absolute;
          inset: -5px;
          ...
          background: linear-gradient(
            90deg,
            rgba(78,179,168,0.14)   0%,
            rgba(180,210,255,0.18)  25%,
            rgba(255,180,230,0.14) 50%,
            rgba(255,165,135,0.14) 75%,
            rgba(78,179,168,0.14) 100%
          );
          background-size: 280% 100%;
          animation: nlBorderShine 7s linear infinite;
          filter: blur(10px);
        ...
        @media (prefers-reduced-motion: reduce) {
          ...
          .nl-shine::before, .nl-shine::after { animation: none; opacity: 0.4; }
          .btn-shine::after { animation: none; opacity: 0; }
        }

        /* ─── 보드마카 손글씨 밑줄 (Hero "상품이 더 팔리는 광고") ─── */
        ...
        .marker-underline {
          ...
          animation: markerDraw 1.4s 0.6s cubic-bezier(0.65, 0, 0.35, 1) both;
        }

        /* ─── Ambient Orb (HA.jsx 패턴) — 글라스 카드가 블러할 대상 ─── */
        .orb {
          position: absolute;
          border-radius: 50%;
          filter: blur(80px);
        ...
        .orb-teal     { background: radial-gradient(circle, rgba(78, 179, 168, 0.40), transparent 70%); }
        .orb-lavender { background: radial-gradient(circle, rgba(231, 227, 255, 0.95), transparent 70%); }
        .orb-coral    { background: radial-gradient(circle, rgba(255, 104, 80, 0.22), transparent 70%); }
        .orb-rose     { background: radial-gradient(circle, rgba(244, 200, 200, 0.55), transparent 70%); }
        .orb-float       { animation: orbFloat 18s ease-in-out infinite; }
        .orb-float-slow  { animation: orbFloat 26s ease-in-out infinite reverse; }

        .over-orb { position: relative; z-index: 1; }
