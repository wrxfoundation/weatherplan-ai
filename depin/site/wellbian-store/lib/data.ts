...
export const FAQS = [
  ...
  { q: "지갑이 처음인데 괜찮나요?", a: "예약에는 지갑이 필요 없습니다. 구매도 국내 카드로 하시면 지갑 없이 됩니다. RLUSD로 결제하시거나 인증서를 NFT로 받고 싶으실 때만 XRPL 지갑이 필요하고, 디센트·Girin·Xaman 같은 외부 지갑으로 로그인하실 수 있습니다." },
...
export const FAQS_EN = [
  ...
  { q: "I have never used a wallet — is that a problem?", a: "You do not need a wallet to reserve. You can also buy without one, by Korean domestic card. An XRPL wallet is only needed if you pay in RLUSD or want your voucher as an NFT — external wallets such as DCENT, Girin and Xaman are supported." },
...
export const FAQS_EXTRA = [
  ...
  { q: "디센트 카드형 지갑은 무엇인가요?", a: "선택 구매 품목입니다. 70,000원(정가 80,000원)에 카드 결제로만 구매하실 수 있고, 기기 NFT나 예매 인증서와는 무관하며 입장권 추첨 대상도 아닙니다." },  /* 9/10 신설 8문항 — 출처: wellbian.io /token·/terms·/membership + 백서 v0.3 정본 스냅샷
