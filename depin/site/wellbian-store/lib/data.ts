...
export const FAQS = [
  ...
  { q: "추첨은 어떤 방식인가요?", a: "제한된 수량을 공정하게 구매하기 위해, 신청자 중 추첨을 통해 당첨된 분에게만 구매 기회를 드리는 방식입니다. 당첨된 분만 정해진 기간 내에 제품을 구매할 수 있으며, 구매하지 않으면 해당 수량은 일반 구매로 넘어갑니다. 결과는 9월 14일 09시(KST) 가입하신 메일로 보내드립니다." },
...
export const FAQS_EN = [
  ...
  { q: "How does the draw work?", a: "To keep a limited quantity fair, a draw among entrants grants the chance to buy to selected participants only. Winners can purchase within a set window; any unbought units are released to general sale. Results are emailed to your sign-up address at 09:00 KST on Sept 14." },
