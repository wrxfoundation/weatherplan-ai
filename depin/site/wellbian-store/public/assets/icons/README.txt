...
--------------
  ...
  칩(데이터가 돌수록 단단해지는 선순환 · 화면에서 34px)   원본 96×96
    data.webp      검증된 데이터    슬래브 3단
    flow.webp      기업이 구매      타일 + 오른쪽 화살표
    coins.webp     대금이 보상 재원  동전 2개
    nodes.webp     측정망 확대      구 4개 + 연결선

규격
----
  형식   WebP (투명 배경 필수)
  크기   카드 192×192 / 칩 96×96   ← 화면 크기의 1.5배 이상이어야 레티나에서 안 뭉갠다
  용량   장당 6KB 이하 (현재 8종 합계 30KB)
