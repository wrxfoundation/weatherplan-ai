...
5. 확장 순서(PLAN.md §5): #2 → #13 (완료: #1 #4 #5 #10 #11 #12 #14 #15 #16 #17 #18 #19)
   ...
   - **노동시장 관측소** = #18 AI 랩 채용(글로벌·잡보드) + #13 워크넷(한국, 키 발급 후)
   - **세 어댑터 계열 모두 라이브**: api-records(#1·#4·#5·#10·#14·#15·#18) · page-text(#11·#12·#17) · file-probe(#16·#19)
