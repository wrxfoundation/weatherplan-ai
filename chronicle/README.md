...
5. 확장 순서(PLAN.md §5): #1 → #2 → #13 → #18 (완료: #4 #5 #11 #12 #14 #15 #16 #19)
   - **AI 경제 원장** = #14 벤더 원장(모델·가격) + #15 컴퓨트 지수(GPU 스팟) 브랜드 축
   - **에이전트 웹 관측소** = #16 동의 센서스(robots·llms.txt) + #19 커머스 센서스(x402·AP2·ACP)
   - **세 어댑터 계열 모두 라이브**: api-records(#4·#5·#14·#15) · page-text(#11·#12) · file-probe(#16·#19)
