...
5. 확장 순서(PLAN.md §5): #1 → #2 → #13 (완료: #4 #5 #10 #11 #12 #14 #15 #16 #18 #19)
   - **★ 코어 소스 10종 도달** — v4 동결 규율(신규 검토는 코어 크론 10개×30일 무사고 후)의
     카운트 충족. 30일 무사고 가동 시 후보 큐(한국 AI-DC 등) 해제
   ...
   - **세 어댑터 계열 모두 라이브**: api-records(#4·#5·#10·#14·#15·#18) · page-text(#11·#12) · file-probe(#16·#19)
