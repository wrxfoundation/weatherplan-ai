...
const STEPS = [
  ...
  },
  {
    ...
    what: '10MW 이상은 전력계통영향평가 대상. 수도권은 지역 배점에서 불리, 비수도권은 AIDC 특별법(2027.2)으로 일정 규모 이하 면제 가능. 계통 여유용량이 큰 권역을 먼저 본다.',
    source: '기후에너지환경부 공고 제2025-139호 · AIDC 특별법',
    links: [{ to: '/power', label: '전력지도(발전·여유)' }, { to: '/insights/psia-exemption-2027', label: '계통영향평가·특례' }],
  },
  {
