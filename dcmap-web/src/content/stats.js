...
/* 발전사업 허가 파이프라인 — 전기위 3MW 초과 허가대장 (사용자 제공, 2026.07)
 * 정직성: PDF 추출 텍스트라 개별 용량 파싱은 불신뢰 → 개별 수치 미발행.
 * 방향성만 정성적으로: 연료태그된 건의 다수가 재생에너지(풍력·연료전지·태양광). */
export const GEN_PIPELINE = {
  headline: '재생에너지가 압도적',
  detail:
    '전기위 3MW 초과 발전사업 허가대장에서 연료원이 확인되는 프로젝트의 다수(등재 건수 기준 약 80%)가 풍력·연료전지·태양광 등 재생에너지 — 석탄·LNG는 소수. AIDC의 RE100 조달 여건에 직접 닿는 공급측 신호다. (허가대장은 이력 누적분 포함, 용량 아님·등재 건수 기준)',
  source: '전기위원회(korec.go.kr) 3MW 초과 발전사업 허가대장 — 명당 D1 발전소 트랙 시드',
}
